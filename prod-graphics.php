  ...
  <div class="container bg-light">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h4 class="my-4">Placas de Video</h4>
        <!-- Barra de Navegación Izquierda-->

        <?php
        require_once("navbarIzq-graphics.php");
        ?>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="img/ofertaA-carrousel-900x350.png" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="img/ofertaB-carrousel-900x350.png" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="img/ofertaC-carrousel-900x350.png" alt="Third slide">
            </div>
          </div>
